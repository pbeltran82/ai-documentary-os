...
from .editorial_overrides import apply_scene_override
...
def build_scene_visual_plan(scene) -> VisualPlan:
    """Adapter for SQLAlchemy Scene with optional approved editorial direction."""
    ...
    return apply_scene_override(scene, plan)
