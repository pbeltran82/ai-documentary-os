...
class OpeningFramePolishTests(unittest.TestCase):
    ...
    def test_later_generated_clip_keeps_existing_edge_treatment(self) -> None:
        ...
        with patch.object(opening, "_previous_normalized_video_filter", return_value="previous-filter") as previous:
    ...
    def test_authored_opening_disables_project_edge_fade(self) -> None:
        ...
        with patch.object(opening, "_previous_build_filter_graph", return_value="graph") as previous:
    ...
    def test_opening_normalizer_and_final_music_graph_are_both_installed(self) -> None:
        self.assertIs(timeline_builder.normalized_video_filter, opening.normalized_video_filter)
        self.assertIs(timeline_builder.build_filter_graph, music.build_filter_graph)
